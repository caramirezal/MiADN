...
########################################################################
## Extract genotype
getPowerEndurance <- function(filePath,output="default"){
        ## set output path
        if (output=="default") {
        ...
        for (i in 1:length(snps)){
                ...
                if ( nchar(snpLine) > 50 ){
                        if (language == "Spanish"){
                                effect <- substr(snpLine,71,nchar(snpLine))
                                effect <- sub("   ","",effect)
                                effect <- sub("  ","",effect)
                        }
                        if (language == "English"){
...
powerEnduranceMiner <- function(fPath){
        ...
        for (i in 1:length(filePaths)) {
                print(filePaths[i])
                res <- getPowerEndurance(filePaths[i])
